        ...
        <Table striped bordered hover responsive className="mt-3 text-center">
          ...
          <tbody>
            <tr>
              ...
              <td>Irrigation: Ensure good soil moisture. Apply phosphorus-rich fertilizer to help germination.</td>
            </tr>
            <tr>
              ...
              <td>Irrigation: Continue irrigation as needed. Fertilization: Apply nitrogen to support early growth.</td>
            </tr>
            <tr>
              <td>December</td>
              <td><strong>Early Growth</strong></td>
              <td>Wheat starts germinating and entering early growth stages.</td>
              <td>Irrigation: Keep the soil moderately moist. Pest Control: Monitor for early pests.</td>
            </tr>
            <tr>
              <td>January</td>
              <td><strong>Growth Phase</strong></td>
              <td>Wheat grows, and leaf development occurs.</td>
              <td>Irrigation: Maintain consistent irrigation. Fertilization: Apply balanced fertilizers.</td>
            </tr>
            <tr>
              <td>February</td>
              <td><strong>Growth Phase</strong></td>
              <td>Wheat continues to grow, focusing on tillering.</td>
              <td>Pest Control: Watch out for fungal diseases. Irrigation: Ensure the crop gets adequate water.</td>
            </tr>
            <tr>
              <td>March</td>
              <td><strong>Growth Phase</strong></td>
              <td>The crop matures further, and heads begin to form.</td>
              <td>Irrigation: Reduce watering to prevent waterlogging. Fertilization: Apply nitrogen for head formation.</td>
            </tr>
            <tr>
              <td>April</td>
              <td><strong>Pre-Harvest</strong></td>
              <td>Wheat begins ripening. Monitor for pests that may attack the mature crop.</td>
              <td>Irrigation: Reduce irrigation as the crop nears harvest. Harvest Prep: Check for grain hardness.</td>
            </tr>
            <tr>
              ...
              <td>Harvesting: Harvest in the early morning or evening to avoid moisture loss.</td>
            </tr>
          </tbody>
        </Table>
      </Container>
